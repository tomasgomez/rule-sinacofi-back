...
export const seed673 = async (prisma, rules, options, actions) => {
 ...
 await connectSchemaToParameter(prisma, [{ messageCode: schema673.messageCode, parameters: params }]);

 // connect parameterToSchema
 const paramsToSchema = params.map((param) => ({ name: param.name, messageCode: param.messageCode, priority: param.priority, schemas: [schema673] }))
