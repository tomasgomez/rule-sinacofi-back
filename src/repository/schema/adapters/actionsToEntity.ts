...
import { IParamterActionResponse } from "../entities/manyToMany";


const actionsToEntity = (actions: IParamterActionResponse[]): Action[] => {
    try {
        const actionsAdapted = actions.map((r: IParamterActionResponse) => {
