...
type IParameterOptionValueSelect = Omit<Prisma.ParametersOptionsSelect, 'optionValue'> & { optionValue?: IOptionValueArgs };
type IParemterRuleSelect = Omit<Prisma.RulesParametersSelect, 'rule'> & { rule?: IRuleArgs };
type IParameterOptionArgs<TArgs = Prisma.ParametersOptionsDefaultArgs> = Omit<TArgs, 'select'> & { select: IParameterOptionValueSelect };
type IParemterRuleSelectArgs<TArgs = Prisma.ParametersOptionsDefaultArgs> = Omit<TArgs, 'select'> & { select: IParemterRuleSelect };
